...
const TodoItem = ({ task, deleteTask, toggleCompleted }) => {
	...
	return (
		<div className="flex justify-between items-center border-b border-slate-200 py-3 px-2 border-l-4 border-l-transparent hover:bg-slate-100 transition ease-linear duration-150"
	  >
